		...
		//////////////////////////////////////////////////////////////////////////////////////
			...
			// Settings
				settings: {
					...
					// DELETED popupOverlayColor & popupOverlayOpacity
					
					// Mobile only
						autoStyleMobile:	false,		// If true, mobile mode will get some automatic styling
					...
					// Desktop only
						...
						mainScrollFactor:	1, 			// Scales the main window scroll delta (1 = normal, 2 = double, 0.5 = half, etc.)
							...
							if (!_.isTouch && _.settings.useScrollZones)
							{
								...
								$SZRight.bind('mouseenter', function(e) {
									SZIntervalId = window.setInterval(function() {
										_.objects.main.scrollLeft( _.objects.main.scrollLeft() + (_.settings.scrollZoneAmount * _.settings.mainScrollFactor) );
										$SZ._parallelism_update();
						...
						// Scroll Keys
							if (_.settings.useScrollKeys)
							{
								_.objects.window.keydown(function(e) {
									if ($('.poptrox-popup').is(':visible')) //CHANGE to if a modal is visible
										return;
									...
									switch (e.keyCode)
									{
										case 39:
											window.clearInterval(SZIntervalId);
											_.objects.main.scrollLeft( _.objects.main.scrollLeft() + (_.settings.scrollKeyAmount * _.settings.mainScrollFactor) );
											$SZ._parallelism_update();
											return false;
