...
var skel=function() {
    var _= {
    config:  {
    prefix: null, preloadStyleSheets:!1, pollOnce:!1, resetCSS:!1, normalizeCSS:!1, boxModel:null, useOrientation:!1, useRTL:!1, pollOnLock:!1, usePerpetualLock:!0, useDomainLock:!0, containers:960, grid: {
    collapse: !1, gutters:40;
}
, breakpoints: {
    all:  {
    range: "*", hasStyleSheet:!1;
}
}, events: {
}
}
, isConfigured:!1, isInit:!1, lockState:null, stateId:"", me:null, breakpoints:[], breakpointList:[], events:[], plugins: {
}
, cache: {
    elements:  {
}
...
, locations: {
    html: null, head:null, body:null;
}
, vars: {
}
, lsc:"_skel_lock", sd:" ", css: {
...
", n:'article, aside, details, figcaption, figure, footer, header, hgroup, main, nav, section, summary {
    display: block;
}
audio, canvas, video {
...
, standard: {
    breakpoints:  {
    mobile:  {
    range: "-480", lockViewport:!0, containers:"fluid", grid: {
    collapse: 1, gutters:10;
}
}, desktop: {
    range: "481-", containers:1200;
}
, "1000px": {
    range: "481-1200", containers:960;
}
}}}, defaults: {
    breakpoint:  {
    test: null, config:null, elements:null;
}
, config_breakpoint: {
    range: "", containers:960, lockViewport:!1, viewportWidth:!1, viewport:"", hasStyleSheet:!0, grid: {
}
}
...
return t;
    ...
    if(window[t]!==undefined&&!r.match(/(Firefox;
     Mobile)/))return window[t];
    if(window[n]) {
...
, unlock:function() {
    _.lockState=null, document.cookie=_.lsc+"=;
    expires=Thu,  1 Jan 1970 12: 00:00 UTC;
     path="+(_.config.useDomainLock?"/": window.location.pathname), _.config.pollOnLock?_.poll():window.location.reload();
}
, lock:function(e) {
    _.lockState=e, document.cookie=_.lsc+"="+e+";
    expires="+(_.config.usePerpetualLock?"Thu,  1 Jan 2077 12: 00:00 UTC":0)+";
     path="+(_.config.useDomainLock?"/": window.location.pathname), _.config.pollOnLock?_.poll():window.location.reload();
}
, getLock:function() {
    return _.lockState;
...
, _.locations[e]=t;
    ...
    id: e, object:t, location:n, priority:r;
}
...
, detachAllElements:function() {
    ...
    var t="vars", n="stateId", r="states", i="cache", s="config", o="iterate", u="breakpoints", a="getCachedElement", f="cacheElement", l="newInline", c="head", h="push", p="elements", d="prefix", v="newStyleSheet", m=".css", g="viewport", y="viewportWidth", b=", ", w="lockViewport", E="parseMeasurement", S="containers", x="}
", T="gutters", N="grid", C=" 0 0 ", k="collapse", L=".row", A="length", O=" {
    display: none!important;
}
", M="parentNode", D="hasOwnProperty", P=!1, H="insertBefore", B, j, F, I, q, R, U, z;
...
"), c, 2)), F[p][h](q));
    ...
    if(!(q=_[a](R))) {
    var V, $, J;
    V=W*.75+X, $=W+X, J=W*1.25+X, q=_[f](R, _[l]("body {
    min-width: "+$+x+".container {
    margin-left: auto;
    margin-right: auto;
    width: "+$+x+".container.small {
    width: "+V+x+".container.big {
    width: 100%;
    max-width: "+J+";
    min-width: "+$+x), c, 3);
}
F[p][h](q), R="iG", (q=_[a](R))||(q=_[f](R, _[l](".\\31 2u {
    width: 100%}
.\\31 1u {
    width: 91.6666666667%}
.\\31 0u {
...
"), c, 3)), F[p][h](q), R="iGR", (q=_[a](R))||(q=_[f](R, _[l](".row>* {
    float: left;
...
"), c, 3)), F[p][h](q), R="iGG"+F[s][N][T];
    if(!(q=_[a](R))) {
    var K, Q, G, Y, Z, et, tt;
    I=_[E](F[s][N][T]), K=I[0], Q=I[1], G=K+Q, Y=K/2+Q, Z=K/4+Q, et=K*1.5+Q, tt=K*2+Q, q=_[f]("iGG"+F[s][N][T], _[l](".row.flush {
    margin-left: 0;
}
.row.flush>* {
    padding: 0!important;
...
.row>* {
    padding-left: "+G+x+".row+.row>* {
    padding: "+G+C+G+x+".row {
    margin-left: -"+G+x+".row.half>* {
    padding-left: "+Y+x+".row+.row.half>* {
    padding: "+Y+C+Y+x+".row.half {
    margin-left: -"+Y+x+".row.quarter>* {
    padding-left: "+Z+x+".row+.row.quarter>* {
    padding: "+Z+C+Z+x+".row.quarter {
    margin-left: -"+Z+x+".row.oneandhalf>* {
    padding-left: "+et+x+".row+.row.oneandhalf>* {
    padding: "+et+C+et+x+".row.oneandhalf {
    margin-left: -"+et+x+".row.double>* {
    padding-left: "+tt+x+".row+.row.double>* {
    padding: "+tt+C+tt+x+".row.double {
    margin-left: -"+tt+x), c, 3);
}
F[p][h](q);
    if(F[s][N][k]) {
    ...
    switch(nt) {
    case 4: break;
    case 3: U+=":not(.no-collapse-3)";
    break;
    case 2: U+=":not(.no-collapse-2):not(.no-collapse-3)";
    break;
    case 1: default:U+=":not(.no-collapse-1):not(.no-collapse-2):not(.no-collapse-3)"}
I=_[E](F[s][N][T]), z=I[0]/2+I[1], q=_[f](R, _[l](L+U+" {
    margin-left: 0;
}
"+L+U+">* {
...
"+".row:not(.flush)"+U+">* {
    padding: "+z+" 0 "+z+" 0!important;
}
"+".container {
    max-width: none!important;
    min-width: 0!important;
    width: "+F.values[S]+"!important;
}
"), c, 3);
}F[p][h](q);
}R="iCd"+_[n];
...
, newInline: function(e) {
    ...
    return _.vars.IEVersion<=8?(n=document[t]("span"), n.innerHTML='&nbsp;
    <style type="text/css">'+e+"</style>"): (n=document[t]("style"), n.type="text/css", n.innerHTML=e), n;
}
, newDiv:function(e) {
...
, _[i](_[r], _.presets[s[t]]), _[i](_[r], s)): (s[n]&&(_[r][n]= {
}
), _[i](_[r], s))), _[i](_[u][o].grid, _[r].grid), _[u][o][a]=_[r][a], _.iterate(_[r][n], function(t) {
    typeof _[r][n][t]!=e&&(_[r][n][t]= {
    range: _[r][n][t];
}
), c= {
}
, _[i](c, _[u][o]), _[i](c, _[r][n][t]), _[r][n][t]=c, b= {
}
, _[i](b, _[u].breakpoint), b[r]=_[r][n][t], b.test=buildTest(t, b[r].range), b.elements=[], _[n][t]=b, _[r].preloadStyleSheets&&b[r].hasStyleSheet&&preloads.push(_[r].prefix+"-"+t+".css"), _.breakpointList.push(t);
}
...
: _.iterate=function(e, t) {
    ...
    ios: "(iPad|iPhone|iPod)", android:"Android", mac:"Macintosh", wp:"Windows Phone", windows:"Windows NT"}
, _.iterate(o, function(r) {
    u[t](new RegExp(o[r], "g"))&&(_[e][n]=r);
}
);
    switch(_[e][n]) {
    case"ios": u[t](/([0-9_]+) like Mac OS X/), s=parseFloat(RegExp.$1[r](i, ".")[r](i, ""));
    break;
    case"android": u[t](/Android ([0-9\.]+)/), s=parseFloat(RegExp.$1);
    break;
    case"mac": u[t](/Mac OS X ([0-9_]+)/), s=parseFloat(RegExp.$1[r](i, ".")[r](i, ""));
    break;
    case"wp": u[t](/IEMobile\/([0-9\.]+)/), s=parseFloat(RegExp.$1);
    break;
    case"windows": u[t](/Windows NT ([0-9\.]+)/), s=parseFloat(RegExp.$1);
    break;
    default: s=99;
}
_[e].deviceVersion=s, _[e].isTouch=_[e][n]=="wp"?navigator.msMaxTouchPoints>0:"ontouchstart"in window, s=document.cookie.split(";
